...
MODULE_CATALOG: tuple[ModuleSpec, ...] = (
    ...
    ModuleSpec("web.object_authorization", "Object-level authorization", "Compare explicitly configured owned and peer objects under one low-privilege session.", ModuleDomain.WEB, active=True, implemented=True, tool="playwright"),
    ...
    ModuleSpec("web.graphql_auth_surface", "GraphQL authorization surface", "Identify auth-sensitive GraphQL fields and routes for read-only role comparison.", ModuleDomain.WEB, active=True, implemented=True),
    ...
    ModuleSpec("web.websocket_auth_surface", "WebSocket authorization surface", "Inventory authentication signals on WebSocket endpoints without connecting.", ModuleDomain.WEB, active=True, implemented=True),
    ...
    ModuleSpec("ai.tool_rag_bridge", "Tool/RAG bridge", "Connect AI tool and retrieval surfaces into bounded authorization and data-flow follow-ups.", ModuleDomain.AI, active=True, implemented=True),
